...
import { Sparkles, Check, DollarSign, TrendingUp, Target, BarChart3, AlertTriangle, Users, type LucideIcon } from "lucide-react";
...
interface ARIAPortfolioAnalysisLoaderProps {
  onComplete: () => void;
}

export function ARIAPortfolioAnalysisLoader({ onComplete }: ARIAPortfolioAnalysisLoaderProps) {
  const [progress, setProgress] = useState(0);
  const [currentDimension, setCurrentDimension] = useState(0);
  const [dimensionsState, setDimensionsState] = useState<AnalysisDimension[]>([
    {
      title: "Saldos & Posiciones",
      description: "Análisis de saldos pasivos y activos",
      icon: DollarSign,
      status: "pending",
      insights: "Evaluando $42.2M en saldos pasivos y $11.7M en activos"
    },
    {
      title: "Tendencias de Crecimiento",
      description: "Proyección y variación YTD",
      icon: TrendingUp,
      status: "pending",
      insights: "Detectando tendencias positivas vs metas YTD"
    },
    {
      title: "Oportunidades Detectadas",
      description: "Identificación de oportunidades del día",
      icon: Target,
      status: "pending",
      insights: "Analizando 6 campañas activas y potencial de impacto"
    },
    {
      title: "Margen & Rentabilidad",
      description: "Análisis de márgenes financieros",
      icon: BarChart3,
      status: "pending",
      insights: "Calculando margen promedio de 4.25% en cartera"
    },
    {
      title: "Riesgo & Mora",
      description: "Evaluación de exposición al riesgo",
      icon: AlertTriangle,
      status: "pending",
      insights: "Monitoreando mora >90 días en 3.8% de clientes"
    },
    {
      title: "Vinculación de Clientes",
      description: "Análisis de principalidad y lealtad",
      icon: Users,
      status: "pending",
      insights: "Identificando 62% de clientes con alta vinculación"
    }
  ]);
      ...
      <div className="relative z-10 max-w-2xl w-full mx-auto px-6">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-3xl font-bold">ARIA está analizando tu cartera</h1>
          </div>
          <p className="text-muted-foreground text-lg">
            Análisis General de Portafolio en Proceso
          </p>
        </motion.div>
        ...
        >
          <p>Procesando datos de 926 clientes con IA generativa...</p>
        </motion.div>
      </div>
    </div>
  );
